...
#DEFAULT_SEM_LLM_SPECS = [{"provider": "openai", "model": "gpt-4.1-mini"}, {"provider": "openai", "model": "gpt-5-mini"}, {"provider": "ollama", "model": "gemma3:270m"}, {"provider": "ollama", "model": "gemma3:1b"}, {"provider": "ollama", "model": "ministral-3:latest"}]
DEFAULT_SEM_LLM_SPECS = [{"provider": "ollama", "model": "gemma3:1b"}]
